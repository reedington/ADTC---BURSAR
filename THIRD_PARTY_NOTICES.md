...
Before Gate 1, the final model card and every training/proxy dataset must be added here with its
source URL, version or commit, license, and any required attribution. Data with unclear or
incompatible licensing must not be used.
